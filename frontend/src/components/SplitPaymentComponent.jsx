...
const SplitPaymentComponent = ({
  ...
  const handleRazorpayPayment = async () => {
    ...
    const options = {
      ...
      name: "Housemate",
      description: `Rent Payment for ${paymentDetails.propertyTitle}`,
      ...
      notes: {
        ...
        property_title: paymentDetails.propertyTitle,
        base_amount: paymentDetails.baseAmount,
        admin_fee: paymentDetails.adminFee,
      },
      theme: {
        color: "#3B82F6",
      },
  ...
  const verifyPayment = async (response) => {
    ...
    try {
      const verifyResponse = await fetch(
        `${Backendurl}/api/payments/verify-split-payment`,
        {
          method: "POST",
          headers: {
            "Content-Type": "application/json",
      ...
      if (data.success) {
        toast.success(
          "Payment successful! Amount will be split between property owner and admin."
        );
  ...
  return (
    <div className="max-w-md mx-auto bg-white rounded-lg shadow-lg p-6">
      <div className="text-center mb-6">
        ...
        <p className="text-gray-600">{paymentDetails.propertyTitle}</p>
      </div>
          ...
          <div className="space-y-2">
            <div className="flex justify-between items-center">
              <div className="flex items-center">
                ...
                <span className="text-gray-700">
                  Property Owner (Base Rent):
                </span>
              </div>
              <span className="font-medium text-gray-900">
                {formatCurrency(paymentDetails.baseAmount)}
              </span>
            </div>
            ...
            <div className="flex justify-between items-center">
              <div className="flex items-center">
                ...
                <span className="text-gray-700">Admin Fee:</span>
              </div>
              <span className="font-medium text-gray-900">
      ...
      <div className="text-xs text-gray-500 text-center">
        ...
        <p>Base amount goes to property owner, admin fee goes to platform</p>
      </div>
    </div>
  );
};
